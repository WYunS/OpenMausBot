...
export interface TaskRecord {
  ...
  /** picker selection used by the most recently dispatched turn. Provider
   * changes can share one driver instance (for example openai -> custom),
   * but their native sessions are not interchangeable. */
  lastModel?: string;
